...
export default async function ClubPage({ params }: { params: Promise<RouteParams> }) {
  ...
  const { club, matchesByMode, standingsByMode, news, members, memberCount, trainingSchedules, documents } = data;
  ...
  return (
    <>
      ...
      club={{
        ...
        logo: club.logo,
        foundedYear: club.foundedYear,
        homeVenueGazon: club.homeVenueGazon,
        homeVenueSalle: club.homeVenueSalle,
        trainingVenueGazon: club.trainingVenueGazon,
        trainingVenueSalle: club.trainingVenueSalle,
      }}
