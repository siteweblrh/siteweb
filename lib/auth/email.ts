...
Un compte vous a été créé sur le site de la Ligue Régionale de Hockey pour ${targetText}.
...
`;
  ...
  <table role="presentation" style="max-width:540px;margin:0 auto;background:#fff;border:1px solid rgba(10,18,32,0.08);border-top:4px solid #F3BC1C;border-collapse:collapse">
    <tr><td style="padding:28px 32px">
      ...
      <p style="margin:14px 0 0;font-size:14px;line-height:1.55;color:#1F2937">Un compte vous a été créé sur le site de la <strong>Ligue Régionale de Hockey</strong> pour ${target}.</p>
      ...
      <div style="margin-top:24px;padding-top:18px;border-top:1px dashed rgba(10,18,32,0.14);font-family:ui-monospace,monospace;font-size:10px;color:#6B7280;letter-spacing:0.14em;text-transform:uppercase">◉ Ligue Régionale de Hockey · <a href="mailto:contact@lrh.re" style="color:#002244;text-decoration:none">contact@lrh.re</a></div>
    </td></tr>
  </table>
</body></html>`;
...
`;
  ...
  <table role="presentation" style="max-width:540px;margin:0 auto;background:#fff;border:1px solid rgba(10,18,32,0.08);border-top:4px solid #F3BC1C;border-collapse:collapse">
    <tr><td style="padding:28px 32px">
      ...
      <div style="margin-top:24px;font-family:ui-monospace,monospace;font-size:10px;color:#6B7280;letter-spacing:0.14em;text-transform:uppercase">◉ Ligue Régionale de Hockey</div>
    </td></tr>
  </table>
</body></html>`;
