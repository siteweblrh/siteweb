 ...
 */
export async function replaceCompetitionDateSlots(
  calendarId: string,
  competitionId: string,
...
export async function moveDraftCompetitionDate(
  ...
  await replaceCompetitionDateSlots(calendarId, competitionId, fromDateISO, toDateISO);
  revalidateDraft();
}
...
export async function removeDraftCompetitionFromDate(
  ...
  await replaceCompetitionDateSlots(calendarId, competitionId, dateISO, dateISO, 0);
  revalidateDraft();
}
...
export async function setDraftCompetitionDateSlotCount(
  ...
  await replaceCompetitionDateSlots(calendarId, competitionId, dateISO, dateISO, count);
  revalidateDraft();
}
