...
-- CreateEnum
CREATE TYPE "NewsCategory" AS ENUM ('ACTUALITE', 'RESULTAT', 'EVENEMENT', 'COMMUNIQUE');
...
CREATE TABLE "News" (
    ...
    "coverImage" TEXT,
    "category" "NewsCategory" NOT NULL DEFAULT 'ACTUALITE',
...
-- CreateIndex
CREATE UNIQUE INDEX "Member_license_key" ON "Member"("license");
